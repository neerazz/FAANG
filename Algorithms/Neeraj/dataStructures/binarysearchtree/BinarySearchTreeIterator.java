...
public class BinarySearchTreeIterator {
    public static void main(String[] args) {
        BSTIterator bstIterator = new BSTIterator(ValidateBinarySearchTree.createTreeNode(new Integer[]{7, 3, 15, null, null, 9, 20}));
    }
}
...
class BSTIterator {
    ...
    public BSTIterator(TraverseATree.TreeNode root) {
        performInorderTraversal(root);
    }

    private void performInorderTraversal(TraverseATree.TreeNode root) {
        if (root == null) return;
