...
public class CountUnivalueSubtrees {
    ...
    public static void main(String[] args) {
        ...
        count = 0;
        treeNode = TraverseATree.createTreeNode(new ArrayList<>(Arrays.asList(5, 1, 3, 1, 1, 1)));
        System.out.println("Answer is: " + countUnivalSubtrees(treeNode) + " should be [4].");
        count = 0;
        treeNode = TraverseATree.createTreeNode(new ArrayList<>(Arrays.asList(7, 82, 82, -79, 98, 98, -79, -79, null, -28, -24, -28, -24, null, -79, null, 97, 65, -4, null, 3, -4, 65, 3, null, 97)));
