...
public class ArticulationPointsAndBridges {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> ap = getArticulationPoints(vertices, edges);
        List<String> bridges = getBridges(vertices, edges);
...
//                    If the dependent lowest point is greater than current discovery point, then it is a critical bridge.
    ...
    private static List<Integer> getArticulationPoints(int n, boolean[][] edges) {
        dis = 0;
        int[] discovery = new int[n], lowest = new int[n];
        boolean[] visited = new boolean[n];
        Set<Integer> ap = new HashSet<>();
        articulationPointsDFS(n, edges, discovery, lowest, visited, null, 0, ap);
        return new ArrayList<>(ap);
    }

    private static void articulationPointsDFS(int n, boolean[][] edges, int[] discovery, int[] lowest, boolean[] visited, Integer parent, int cur, Set<Integer> ap) {
